...
#define MAX32664_DEFAULT_ADDRESS 0x55   //default chip address(slave address) of MAX32664

#define ACQ_I2C_SAMPLE_RATE 10  //In Hz

#define CONFIDENCE_THRESHOLD 90     //Threshold in which a sample is considered valid (confidence >= CONFIDENCE_THRESHOLD -> valid sample)
