...
#define ABAT_ADC_CH ADC2_CHANNEL_5 // GPIO33
#elif HW_VERSION == HW_VERSION_NANO
#define ABAT_ADC_CH ADC1_CHANNEL_2 // GPIO38
#elif HW_VERSION == HW_VERSION_BINEDGE_AUDIO
#define ABAT_ADC_CH ADC1_CHANNEL_5 // GPIO33
#endif
...
#define READ_ADC2(value, channel) ({ adc2_get_raw((channel), ADC_RESOLUTION, &(value)); })
