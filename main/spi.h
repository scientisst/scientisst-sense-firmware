...
#define RDATAC \
    0x10  // enable Read Data Continuous mode - the default at power-up
#define SDATAC 0x11  // stop Read Data Continuously mode
#define RESET 0x06   // Reset ADS
#define RREG \
    0x20;  // read n nnnn registers starting at address r rrrr |||| first byte
           // 001r rrrr (2xh)(2) - second byte 000n nnnn(2)
#define WREG \
    0x40;  // write n nnnn registers starting at address r rrrr |||| first byte
           // 010r rrrr (2xh)(2) - second byte 000n nnnn(2)
...
#define FSHUTDOWN \
    0b110100  // Full Shutdown; the internal config registers keep the values
